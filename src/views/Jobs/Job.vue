<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  ...
  <div>
    ...
    <portal to="toolbar-actions">
      ...
      <v-btn class="mr-3" @click="reopen()" color="secondary"
             v-if="job.status === 'finished' || job.status === 'cancel'">
        Reopen
      </v-btn>
      <v-btn class="mr-3" @click="cancel()" v-if="job.status !== 'finished' || job.status !== 'ongoing' ">Cancel</v-btn>
